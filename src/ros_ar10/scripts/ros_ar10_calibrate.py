...
if __name__ == "__main__":
	...
	This script is used to perform calibration for each joint

	:Arguments:
	`--device` (string) - path of the serial device connected with AR10
	`--left/--right` (flag) - calibration will be performed for left hand or right hand 
	"""
