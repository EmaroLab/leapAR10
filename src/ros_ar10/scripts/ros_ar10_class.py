...
class ar10:
	def __init__(self,device_path, calibration_file_path):
		""" AR10 robotic hand control API
			...
			This script is used for all communications with AR10

			:Arguments:
			`device_path` (string) - path of the serial device connected with AR10
			`calibration_file_path` (string) - calibration file path
		"""
		self.speed        = 20
