...
if __name__ == '__main__':
	""" Listener for commands to set AR10 Joints' positions

	This script will create a non anonymous ros node,
	listen over topic "ros_ar10_set_servo_positions"
	and send new positions to robotic hands
	...
	topic_name = 'ros_ar10_set_servo_positions'
