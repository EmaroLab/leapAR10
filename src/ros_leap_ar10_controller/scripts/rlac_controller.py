...
if __name__ == '__main__':
	...
	leap_listener_topic_name = 'ros_leap_frame'
	ar10_left_publisher_topic_name = 'ros_ar10_set_servo_positions.left'
	ar10_right_publisher_topic_name = 'ros_ar10_set_servo_positions.right'
	node_name = 'rlac_node'
